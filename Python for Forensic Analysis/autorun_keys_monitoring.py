...
# Inspired by Howard E. Poston III's book, "Python for Cybersecurity" (Wiley, 2020, ISBN 978-1-119-85064-9), the script 'autorun_keys_monitoring.py' was developed based on the code discussed in the chapter "Registry Monitoring for Defenders".
...
Solution:
- Look for autoruns in the HKEY_CURRENT_USER and HKEY_LOCAL_MACHINE hives in the SOFTWARE\Microsoft\Windows\CurrentVersion\Run and SOFTWARE\Microsoft\Windows\CurrentVersion\RunOnce paths.
- Print the name and data of each autorun found.
"""
